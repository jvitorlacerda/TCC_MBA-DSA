...
##carregando a base de dados original (buscando a base pelo site Cetic.br - fonte dos dados)
base_orig_indv_2018 <- read.csv2("https://cetic.br/media/microdados/209/ticdom_2018_individuos_base_de_microdados_v1.0.csv") 

base_orig_indv_2023 <- read.csv2("https://cetic.br/media/microdados/754/tic_domicilios_2023_individuos_base_de_microdados_v1.0.csv")

#ou pela base local em csv
...
##carregando a base de dados original (buscando a base pelo site Cetic.br - fonte dos dados)
base_orig_domc_2018 <- read.csv2("https://cetic.br/media/microdados/204/ticdom_2018_domicilios_base_de_microdados_v1.0.csv")

base_orig_domc_2023 <- read.csv2("https://cetic.br/media/microdados/758/tic_domicilios_2023_domicilios_base_de_microdados_v1.0.csv")
...
#selecionando somente as observações em que existem acesso à internet
